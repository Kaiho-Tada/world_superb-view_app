...
export const Signup: FC = memo(() => {
  ...
  const { onClickSignup, name, setName, email, setEmail, password, setPassword, passwordConfirmation, setPasswordConfirmation } = useSignup({setLoading});
    ...
    <Flex role="form" align="center" justify="center" height="90vh">
      <Box bg="white" w="sm" p={4} borderRadius="md" shadow="lg">
        ...
        <Stack spacing={4} px={6} py={2}>
          ...
          <Input placeholder="パスワード確認" type="password" value={passwordConfirmation} onChange={onChangePasswordConfirmation} />
